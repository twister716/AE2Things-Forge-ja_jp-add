...
public class AETItems {
    ...
    public static final DeferredItem<Item> DISK_DRIVE_1K = AE2Things.ITEMS.register("disk_drive_1k",
            () -> new DISKDrive(AEItems.CELL_COMPONENT_1K.asItem(), 1, 0.5f));
    public static final DeferredItem<Item> DISK_DRIVE_4K = AE2Things.ITEMS.register("disk_drive_4k",
            () -> new DISKDrive(AEItems.CELL_COMPONENT_4K.asItem(), 4, 1.0f));
    public static final DeferredItem<Item> DISK_DRIVE_16K = AE2Things.ITEMS.register("disk_drive_16k",
            () -> new DISKDrive(AEItems.CELL_COMPONENT_16K.asItem(), 16, 1.5f));
    public static final DeferredItem<Item> DISK_DRIVE_64K = AE2Things.ITEMS.register("disk_drive_64k",
            () -> new DISKDrive(AEItems.CELL_COMPONENT_64K.asItem(), 64, 2.0f));
    public static final DeferredItem<Item> DISK_DRIVE_256K = AE2Things.ITEMS.register("disk_drive_256k",
